...
#define SPI_SEL0_Pin GPIO_PIN_3
#define SPI_SEL0_GPIO_Port GPIOB
#define SPI_SEL1_Pin GPIO_PIN_4
#define SPI_SEL1_GPIO_Port GPIOB
#define SPI_SEL2_Pin GPIO_PIN_5
#define SPI_SEL2_GPIO_Port GPIOB

/* USER CODE BEGIN Private defines */
#define A121_SPI_HANDLE hspi1
#define CAN_CS_Pin SPI2_CS_Pin
#define CAN_CS_GPIO_Port SPI2_CS_GPIO_Port
